                            ...
                            <div class="row">
                                ...
                                <div>
                                    ...
                                    <div class="tadel-center">
                                        <img src="img/sofa1.png" class="img-thumbnail img-responsive" alt="Cinque Terre" width="100" data-toggle="modal" data-target="#reservations" onclick="data_print('{{$table_status_b->id}}', '{{$table_status_b->name}}', '{{$table_status_b->seating}}')">
                                    </div>
                                    <div class="tadel-center">
                                    {{$table_status_b->name}} {{$table_status_b->seating}} ที่นั่ง @else
                                  </div>
                                    <br>
                                    <div class="tadel-center">
                                    ...
                                    <div class="tadel-center">
                                    {{$table_status_b->name}} {{$table_status_b->seating}} ที่นั่ง @endif
                                  </div>
                                </div>
                                ...
                                @endforeach @foreach ($table_status_d as $index => $table_statu)
                                <div>
                                    @if($table_statu->status == 1)
                                    <div class="tadel-center">
