...
<head>
 ...
 /* #overlay{
      ...
      <script src="{{ secure_asset('/vendor/metisMenu/metisMenu.min.js') }}"></script>

      <!-- Toastr JavaScript -->
      <script src="{{ secure_asset('/vendor/toastr/js/toastr.min.js') }}"></script>

      <!-- Custom Theme JavaScript -->
      <script src="{{ secure_asset('/assets/js/sb-admin-2.js') }}"></script>
      ...
      <script src="{{ secure_asset('/vendor/datatables-plugins/dataTables.bootstrap.min.js') }}"></script>
      <script src="{{ secure_asset('/vendor/datatables-responsive/dataTables.responsive.js') }}"></script>
